 ...
 *
 * For each direction (vertical, horizontal and diagonal), friendlyNeighborScore = 1 is added to scorePlayer for each
 ...
 * larger; I set the maximum score to Float.MAX_VALUE) and thereby terminate since there is no need to keep look for a
 * better move.
 *
 ...
 * Hence, {@code goalFunction()} will add a score of 1000 for this move. This "protection move" is the second highest
 ...
 * make this move and so preventFourInARowScore = 50 will be added to score.
 ...
 * the grid, the player cannot build further in that direction. A score of -0.2 is added to the score of the move.
 *
 ...
 * protectionScore. I will call this fourInARowScore, and I will set it to 100. The easiest way to implement this is
 ...
 * get five in row that way. Therefore, a move towards the left will be penalized by unableToBuildFiveScore = -10.
 *
 */

public final class ScoreEvaluation {

    // The following scores are sorted from most important to least important
    ...
    private final static float ableToBuildFiveScore = 1f;
